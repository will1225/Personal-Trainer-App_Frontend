...
import { ActivityIndicator, Alert, Button, Modal, ScrollView, Text, TouchableOpacity, View } from "react-native";
            ...
            <ScrollView contentContainerStyle={{ flex: 1, marginHorizontal: 16 }}>
                {
                    profile.userAccount?.stripeId ?
                        (
                            ...
                            <Text className="my-[16px]">Proceed with payment ending with {paymentMethods[0].card.last4}</Text>
                        ) :
                        (
                            <CardField
