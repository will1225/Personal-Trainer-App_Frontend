...
const getRandomGradientColors = () => {
    const colors = [
        '#5851DB', '#5873F4', '#458EEF', '#25BCE7', '#10DAE2', '#C13584', '#E1306C',
        '#FD1D1D', '#F77737', '#36D1DC', '#5B86E5', '#FF7E5F', '#feb47b', '#00c6ff',
        '#0072ff', '#FF8A00', '#FF6347', '#32CD32', '#FFD700', '#FF1493',
        '#9B59B6', '#F39C12', '#D35400', '#1ABC9C', '#2ECC71', '#8E44AD', '#2980B9',
        '#27AE60', '#16A085', '#F1C40F', '#E74C3C', '#95A5A6', '#34495E', '#2C3E50',
        '#1F77B4', '#FF6F61', '#A29BFE', '#FF3366', '#FF33FF', '#2D9CDB', '#D4A5A5',
        '#8B80F9', '#FFB6C1', '#F5CBA7', '#45B39D', '#F0E68C', '#7C3C48', '#A5C1D9',
        '#F9E79F', '#F4A300', '#4D4DFF', '#F74D61', '#8F8F8F', '#4CAF50', '#008080',
        '#FF6347', '#FF4500', '#D2691E', '#EE82EE', '#800080', '#FFD700', '#E0FFFF'
    ];
